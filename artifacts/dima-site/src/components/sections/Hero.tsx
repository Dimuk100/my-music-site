    ...
    <section className="relative flex items-center justify-center pt-20 sm:pt-28 pb-8 sm:pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-white/80 uppercase tracking-wider">New Single Available Now</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold text-gradient leading-[1.15] mb-4 sm:mb-6"
        >
          Dima Vardzelashvili
        </motion.h1>
        ...
        >
          <a href="#music" className="button-primary w-full sm:w-auto text-center">
            Listen Music
          </a>
          <a href="#contact" className="button-outline w-full sm:w-auto text-center">
            Follow
          </a>
        </motion.div>
      </div>
